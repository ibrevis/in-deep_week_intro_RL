...
Usage:
    python run_policy_4x4.py                      # 1 episode, default table_q_learning.npy
    python run_policy_4x4.py --episodes 3         # 3 episodes back to back
    python run_policy_4x4.py --q table_sarsa.npy  # a different saved table
...
# is_slippery=False has never had to hedge against slipping, so replaying it on
# a slippery env will walk it straight into a hole.
ENV_KWARGS = dict(
    map_name="4x4",
    is_slippery=False,
...
def main():
    ...
    parser.add_argument("--q", default="table_q_learning.npy", help="path to the saved Q-table")
